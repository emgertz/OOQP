...
The file L<INSTALL|INSTALL>, included in this directory, is the
...
See L<QpBound> for more information.

=item L<Svm|Svm> 

This module creates a support vector machine classifier for solving
the pattern classification problem in machine learning. See the L<Svm>
for more information.

=item L<Huber|Huber>

Solves the Huber regression problem. See L<Huber>.
...
packages are supported or provided. See the L<INSTALL|INSTALL> file
...
instructions found in L<INSTALL|INSTALL>, have been supplied in the
L<README_Matlab|README_Matlab> file. Once the Matlab interface has
...
L<examples/README|examples::README> file for information on the
...
Example problems and programs. See L<examples/README|examples::README>.
