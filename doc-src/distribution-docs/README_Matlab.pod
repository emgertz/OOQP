...
L<INSTALL|INSTALL> file of the OOQP distribution.)
...
L<TROUBLESHOOTING|troubleshooting> section below for more info.
...
for this procedure are given in the L<INSTALL|INSTALL> file of the
...
version rather than sunperf. See the L<INSTALL|INSTALL> file for
